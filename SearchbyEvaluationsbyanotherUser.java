...
public class SearchbyEvaluationsbyanotherUser extends common {

	public SearchbyEvaluationsbyanotherUser() throws ParseException {
		super();
		// TODO Auto-generated constructor stub
	}

	// test for Evaluations by another User
	@Test
	public void executetest() throws IOException {
		...
		try {
			...
			logger = extent.createTest("Search by Evaluations by another User");

			common_searchby("F19", "Evaluations by another User", action, driver);
			...
			save(driver);
			// close_search(search_by, "Evaluations by another User" , action, driver);
		} catch (Exception e) {
			e.printStackTrace();
			logger.log(Status.FAIL, "Search by Evaluations by another User Test Failed");
