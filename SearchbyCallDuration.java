...
public class SearchbyCallDuration extends common {

	public SearchbyCallDuration() throws ParseException {
		super();
	...
	public void executetest() throws IOException, InterruptedException, java.text.ParseException {
		...
		try {
			...
			logger = extent.createTest("Search by Call Duration");

			common_searchby("F7", "Call Duration", action, driver);
			...
			Thread.sleep(1000);
			driver.findElement(By.cssSelector(".condition-type > .ui-autocomplete-input")).sendKeys("duration");
			Thread.sleep(1000);
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@id='condition-modal']/div/div/div/div[2]/div/input")).sendKeys(prop.getProperty("CallbyDurationRange1"));
			Thread.sleep(3000);
			...
			// third condition check
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@id='condition-modal']/div/div/div/div[2]/div/input")).sendKeys(prop.getProperty("CallbyDurationRange2"));
			Thread.sleep(3000);
			...
			for (int i = 1; i <= table_length; i++) {
				String tab_data = driver
						.findElement(By
								.xpath("//*/div/div[4]/div/div/div[1]/div/div[3]/div[2]/div/div/div[" + i + "]/div[6]"))
						.getText();

				if (tab_data != "")
					if (isTimeWith_in_Interval(tab_data, prop.getProperty("CallbyDurationRange1"), prop.getProperty("CallbyDurationRange2")) == true) {
						...
						if (i == table_length) {
							logger.log(Status.PASS, "Validation of Call Duration Test verified");
							logger.log(Status.PASS, "Search by Call Duration Test verified");
						}
						if (i == 13) {
							System.out.print("zz " + '\n');
							logger.log(Status.PASS, "Search by Call Duration Test verified");
						...
						logger.log(Status.FAIL,
								"Validation of Call Duration failed because of " + read_grid_data(driver, i) + " in column " + i);
			...
			// e.printStackTrace();
			logger.log(Status.FAIL, "Search by Call Duration Test Failed");
