...
public class SearchthisWeek extends common {

	public SearchthisWeek() throws ParseException {
		super();
	...
	public void executetest() throws IOException {
		...
		try {
			...
			logger = extent.createTest("Search by this Week");

			common_searchby("F13", "this Week", action, driver);

			driver.findElement(By.xpath("//div[contains(@class, 'ui-menu-item-wrapper') and text()='this week']"))
					.click();
			Thread.sleep(1000);
			...
			for (int i = 1; i <= table_length; i++) {
				...
				if (tab_data != "")
					if (date_compare(tab_data, firstDayOfTheWeek) == true) {
						...
						if (i == table_length) {
							logger.log(Status.PASS, "Validation of this Week Test verified");
							logger.log(Status.PASS, "Search by this week test verified");
						}
						if (i == 13) {
							System.out.print("zz " + '\n');
							logger.log(Status.PASS, "Search by this Week Test verified");
						...
						logger.log(Status.FAIL,
								"Validation of this Week failed because of " + read_grid_data(driver, i) + " in column " + i);
						...
						save(driver);
						// close_search(search_by, "this week", action, driver);
						return;
					}
			...
			e.printStackTrace();
			logger.log(Status.FAIL, "Search by this Week Test Failed");
