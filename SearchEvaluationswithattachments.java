...
public class SearchEvaluationswithattachments extends common {

	public SearchEvaluationswithattachments() throws ParseException {
		super();
		// TODO Auto-generated constructor stub
	}

	// test for Evaluations with attachments
	@Test
	public void executetest() throws IOException {
		...
		try {
			...
			logger = extent.createTest("Search by Evaluations with attachments");

			common_searchby("F19", "Evaluations with Attachments", action, driver);
			...
			save(driver);
			// close_search(search_by, "Evaluations with attachments" , action, driver);
		} catch (Exception e) {
			e.printStackTrace();
			logger.log(Status.FAIL, "Search by Evaluations with attachments Test Failed");
