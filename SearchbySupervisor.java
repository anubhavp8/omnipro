...
public class SearchbySupervisor extends common {

	public SearchbySupervisor() throws ParseException {
		super();
	...
	public void executetest() throws IOException {
		...
		try {
			...
			Thread.sleep(1000);
			logger = extent.createTest("Search by Supervisor");

			common_searchby("F18", "Supervisor", action, driver);
			...
			logger.log(Status.PASS, "Search by Supervisor Test verified");

			save(driver);
			// close_search(search_by, "Supervisor", action, driver);

		} catch (Exception e) {
			e.printStackTrace();
			logger.log(Status.FAIL, "Search by Supervisor Test Failed");
