...
public class SearchCalibrations extends common {

	public SearchCalibrations() throws ParseException {
		super();
	...
	public void executetest() throws IOException {
		...
		try {
			...
			Thread.sleep(1000);
			logger = extent.createTest("Search by Calibrations");

			common_searchby("F18", "Calibrations", action, driver);
			...
			Thread.sleep(1000);
			driver.findElement(By.cssSelector(".condition-additional .label-input")).sendKeys("calibration");
			Thread.sleep(1000);
			...
			logger.log(Status.PASS, "Search by Calibrations Test verified");

			save(driver);
			// close_search(search_by, "Calibrations", action, driver);

		} catch (Exception e) {
			e.printStackTrace();
			logger.log(Status.FAIL, "Search by Calibrations Test Failed");
