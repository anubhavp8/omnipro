...
public class SearchEvaluations extends common {

	public SearchEvaluations() throws ParseException {
		super();
	...
	public void executetest() throws IOException {
		...
		try {
			...
			Thread.sleep(1000);
			logger = extent.createTest("Search by Evaluations");

			common_searchby("F18", "Evaluations", action, driver);
			...
			logger.log(Status.PASS, "Search by Evaluations Test verified");

			save(driver);
			// close_search(search_by, "Evaluations", action, driver);

		} catch (Exception e) {
			e.printStackTrace();
			logger.log(Status.FAIL, "Search by Evaluations Test Failed");
